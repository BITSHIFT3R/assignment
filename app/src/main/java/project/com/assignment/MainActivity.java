package project.com.assignment;
...
import project.com.assignment.map.Constants;
import project.com.assignment.map.MapActivity;
import project.com.assignment.video.PermissionActivity;
...
public class MainActivity extends AppCompatActivity  implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnScreen1).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent dashboard = new Intent(MainActivity.this, MapActivity.class);

                startActivity(dashboard);
                //overridePendingTransition(R.anim.slide_in_up, R.anim.slide_out_in);
            }
        });
        findViewById(R.id.btnScreen2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent dashboard = new Intent(MainActivity.this, PermissionActivity.class);
